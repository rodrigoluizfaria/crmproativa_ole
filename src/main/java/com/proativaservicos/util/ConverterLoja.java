...
@FacesConverter(value = "converterLoja")
public class ConverterLoja implements Converter,Serializable {
	/**
	 * 
	 */
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		...
		if (value instanceof Loja) {
			...
			Loja entity = (Loja) value;

			if (entity instanceof Loja && entity.getId() != null) {
