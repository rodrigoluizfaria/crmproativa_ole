...
public class ConsultaAssincronaMasterSaque implements Serializable {
    ...
    public void consultarSaque(Importacao importacao, Campanha campanha, Usuario usuario, Empresa empresa) {
        ...
        try {
            ...
            iniciarLogMongoDb(campanha.getDescricao(), importacao.getNomeArquivo(), campanha.getId(), importacao.getId(), this.integracaoWsMaster.getTipoIntegracao().getTipoConsultaEnum());
            ...
            alterarLogMongoDb(null, null, null, listAtendimentos.size(), null,null);
            ...
            alterarLogMongoDb("Sucesso..", "0", "CONSULTADO_COM_SUCESSO", 0, null,null);
            ...
            try {
                ...
                if (this.importacao != null && this.importacao.getId() != null) {
                    ...
                    this.importacaoService.alterar(this.importacao);
                    this.transaction.commit();
                    alterarLogMongoDb("Ocorreu erro.", "Erro: " + e.getMessage(), "NAO_CONSULTADO", 0, null,null);
                }
    ...
    private void reconsulta(Campanha campanha, Empresa empresa, Usuario usuario) throws ProativaException, Exception {
        ...
        if (listAtendimentos != null && !listAtendimentos.isEmpty()) {
            ...
            alterarLogMongoDb("Reconsultando, atendimentos com erro.", null, null, listAtendimentos.size(), null,null);
    ...
    private void consultaSaqueRecursivo(List<Atendimento> atendimentos, Campanha campanha, Empresa empresa, Usuario usuario, Importacao importacao, boolean novaConsulta) {
        ...
        ExecutorService executor = Executors.newFixedThreadPool(MAX_TAREFAS_POR_MINUTO);
        List<Future<Long>> resultados = Collections.synchronizedList(new ArrayList<>());

        for (Atendimento atendimento : atendimentos) {

            double esperaSegundos = rateLimiter.acquire(); // bloqueia até liberar
      //      System.out.printf("[RATE LIMIT] Espera de %.2f segundos para atendimento %d%n", esperaSegundos, atendimento.getId());
            Future<Long> future = executor.submit(() -> executarConsulta(atendimento, campanha, usuario, empresa));
            resultados.add(future);
        }

        aguardarExecucao(executor);
        ...
        if (novaConsulta) {
            ...
            if (CollectionUtils.isNotEmpty(novosAtendimentos)) {
                alterarLogMongoDb(null, null, null, novosAtendimentos.size(), null,null);
    ...
    private Long executarConsulta(Atendimento atendimento, Campanha campanha, Usuario usuario, Empresa empresa) {
        ...
        //  System.out.printf("[MONITORAMENTO] Tarefas nos últimos 60s: %d%n", timestampsExecucao.size());
        alterarLogMongoDb("[MONITORAMENTO] Tarefas nos últimos 60s: "+timestampsExecucao.size(), null, null, 0, null,null);


        //   System.out.printf("[EXECUTANDO] Atendimento: %d | Campanha: %s | Tarefas nos últimos 60s: %d%n", atendimento.getId(), campanha.getDescricao(), timestampsExecucao.size());
        ...
        try {
            ...
            System.err.printf("[ERRO] Atendimento %d: %s%n", atendimento.getId(), e.getMessage());
            alterarLogMongoDb(null, null, null, 0, 1,atendimento.getId());
            return inicio;
        }
    }
        ...
        public Long call() throws Exception {
            ...
            try {
                ...
                if (StringUtils.isBlank(erroAutenticacao)) {
                    ...
                    clienteSaque = ConsultaAssincronaMasterSaque.this.consultaApiMasterSaque.consultaClienteCartaoSaque(ConsultaAssincronaMasterSaque.this.integracaoWsMaster, atendimento.getCpf(), atendimento.getEntidadePrincipal(), usuario, campanha.getId(), atendimento.getId(), true, false);
                    ...
                    alterarLogMongoDb(null,null,null,1,null,null);
                } else {
                ...
                this.atendimento.setValorMaxOperacao(null);
                this.atendimento.setSeguro(null);
                this.atendimento.setObservacao(ConsultaAssincronaMasterSaque.this.tratarErro(e.getMessage()));
                alterarLogMongoDb(null,null,null,1,null,atendimento.getId());
            ...
            ConsultaAssincronaMasterSaque.this.atualizarAtendimento(this.atendimento, this.campanha, this.usuario, this.empresa, this.dadosBancarios);
            return this.inicio;
        }
    ...
    public static void main(String[] args) {
        ...
        ConsultaAssincronaMasterSaque consult = new ConsultaAssincronaMasterSaque();
