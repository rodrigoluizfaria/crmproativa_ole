...
public class ConsultaAssincronaSeguro implements Serializable {
    ...
    public void consultarProdutoSeguro(Importacao importacao, Campanha campanha, Usuario usuario, Empresa empresa) {
        ...
        try {
            ...
            System.out.print("INICIANDO CONSULTA SEGURO: "+campanha.getIntegrarWs().getTipoIntegracao().getTipoConsultaEnum().getConstante()+" | CODIGO: "+campanha.getIntegrarWs().getTipoIntegracao().getTipoConsultaEnum().getCodigo());
            ...
            consultaSeguroRecursivo(listAtendimentos, campanha, empresa, usuario, this.importacao, true);
    ...
    private void reconsulta(Campanha campanha, Empresa empresa, Usuario usuario) throws ProativaException, Exception {
        ...
        if (listAtendimentos != null && !listAtendimentos.isEmpty()) {
            ...
            consultaSeguroRecursivo(listAtendimentos, campanha, empresa, usuario, importacao, false);
    ...
    private void consultaSeguroRecursivo(List<Atendimento> listAtendimentos, Campanha campanha, Empresa empresa, Usuario usuario, Importacao importacao, boolean novaConsulta) {
        // TODO Auto-generated method stub


        List<Future<Long>> listResultadosFuture = new ArrayList<Future<Long>>();

        ThreadPoolExecutor executor = (ThreadPoolExecutor) Executors.newFixedThreadPool(140);
        ...
        for (Future<Long> future : listResultadosFuture) {
            ...
            try {
                ...
                Long inicioExecucao = future.get(70L, TimeUnit.SECONDS);

                imprimirMonitorConsultaSaqueComplementar(executor, campanha.getDescricao());

                if (System.currentTimeMillis() - inicioExecucao.intValue() > 70000L) {
                ...
                if (qtidadeCompletadosAnterior == executor.getCompletedTaskCount()) qtidadeRepetidosCompletos++;
        ...
        if (novaConsulta) {
            ...
            if (CollectionUtils.isNotEmpty(listConsultaNovaAtn)) {
                ...
                consultaSeguroRecursivo(listConsultaNovaAtn, campanha, empresa, usuario, importacao, true);
            }
        }
    ...
    private String tratarErro(String erro) {
        return (erro == null) ? null : erro.replaceAll("com.bmg.econsig.common.exception.ServiceException:", "").replaceAll("SqlMapClient operation", "javax.resource.ResourceException:").replaceAll("com.bmg.consig.common.exception.ConsigSystemException:", "").replaceAll("java.sql.SQLException:", "").replaceAll("javax.resource.ResourceException:", "").trim();
    }
    ...
    class ConsultaSeguro implements Callable<Long> {
        ...
        public Long call() throws Exception {
            ...
            try {
                ...
                if (ConsultaAssincronaSeguro.this.usuarioWsBMG != null && ConsultaAssincronaSeguro.this.senhaWsBMG != null) {

                    ClienteProdutoSeguroBMG clienteSeguro = ConsultaAssincronaSeguro.this.consultaBmgUtil.retornarCartoesDisponiveisSeguroBmg(ConsultaAssincronaSeguro.this.urlWsBMG, ConsultaAssincronaSeguro.this.usuarioWsBMG, ConsultaAssincronaSeguro.this.senhaWsBMG, atendimento, campanha.getId(), usuario, this.campanha.getIntegrarWs().getTipoIntegracao().getTipoConsultaEnum().getCodigo(),false);
                    ...
                    if (clienteSeguro != null && clienteSeguro.getListaCartaoPlanos() != null && !clienteSeguro.getListaCartaoPlanos().isEmpty()) {
                        ...
                        if (dataNascimento != null) this.atendimento.setDataNascimento(dataNascimento);
                        ...
                        else this.atendimento.setObservacao("sem cartao");
                ...
                this.atendimento.setValorMaxOperacao(null);
                this.atendimento.setSeguro(null);
                this.atendimento.setObservacao(ConsultaAssincronaSeguro.this.tratarErro(e.getMessage()));
            ...
            ConsultaAssincronaSeguro.this.atualizarAtendimento(this.atendimento, this.campanha, this.usuario, this.empresa);
            return this.inicio;
        }
    ...
    public static void main(String[] args) {
        ...
        ConsultaAssincronaSeguro consult = new ConsultaAssincronaSeguro();
