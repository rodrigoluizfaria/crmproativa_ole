...
import com.proativaservicos.util.ApiBmgFgtsUtil;
...
public class ConsultaAssincronaFgts  implements Serializable {
    ...
    @Inject
    private ApiBmgFgtsUtil apiFgts;
    ...
    public void consultarRetornoSeTemCartao(Importacao importacao, Campanha campanha, Usuario usuario, Empresa empresa) {
        ...
        try {
            System.out.println("INICIANDO CONSULTA FGTS....");
            ...
            consultaFgtsRecursivo(listAtendimentos, campanha, empresa, usuario, this.importacao, true);
    ...
    private void consultaFgtsRecursivo(List<Atendimento> listAtendimentos, Campanha campanha, Empresa empresa, Usuario usuario, Importacao importacao, boolean novasConsultas) {
        ...
        for (Atendimento atendimento : listAtendimentos) {
            ...
            listResultadosFuture.add(executor.submit(new ConsultaFgts(atendimento, campanha, usuario, empresa)));
        ...
        if (novasConsultas) {
            ...
            if (CollectionUtils.isNotEmpty(listAtendimentosNovos)) {
                ...
                consultaFgtsRecursivo(listAtendimentosNovos, campanha, empresa, usuario, importacao, true);
            }
        }
    ...
    private void reconsultar(Campanha campanha, Empresa empresa, Usuario usuario) throws ProativaException, Exception {
        ...
        if (listAtendimentos != null && !listAtendimentos.isEmpty()) {
            ...
            consultaFgtsRecursivo(listAtendimentos, campanha, empresa, usuario, this.importacao, false);
    ...
    class ConsultaFgts implements Callable<Long> {
        ...
        public ConsultaFgts(Atendimento atendimento, Campanha campanha, Usuario usuario, Empresa empresa) {
        ...
        public Long call() throws Exception {
            ...
            try {
                ...
                if (ConsultaAssincronaFgts.this.usuarioWsBMG != null && ConsultaAssincronaFgts.this.senhaWsBMG != null) {

                    String retorno = ConsultaAssincronaFgts.this.apiFgts.retornarSimulacaoFgts(ConsultaAssincronaFgts.this.urlWsBMG, ConsultaAssincronaFgts.this.usuarioWsBMG, ConsultaAssincronaFgts.this.senhaWsBMG, ConsultaAssincronaFgts.this.clientId, ConsultaAssincronaFgts.this.clientId, ConsultaAssincronaFgts.this.clientId, atendimento, campanha.getId(), usuario, true, false);
                ...
                this.atendimento.setObservacao(ConsultaAssincronaFgts.this.tratarErro(e.getMessage()));
            ...
            ConsultaAssincronaFgts.this.atualizarAtendimento(this.atendimento, this.campanha, this.usuario, this.empresa);
