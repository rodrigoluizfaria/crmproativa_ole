...
public class ConsultaAssincronaApiPanSimulacao implements Serializable {
    ...
    class ConsultaSimulacaoSaque implements Callable<Long> {
        ...
        public Long call() throws Exception {
            ...
            try {
                ...
                if (ConsultaAssincronaApiPanSimulacao.this.autenticar()) {

                    ResponseSaqueVista response = ConsultaAssincronaApiPanSimulacao.this.apiPanSaque.retornarSimulacao(ConsultaAssincronaApiPanSimulacao.this.urlApi + URL_SIMULACAO, ConsultaAssincronaApiPanSimulacao.this.apiKey, ConsultaAssincronaApiPanSimulacao.this.token, criarClientRequestPan(atendimento), this.campanha.getId(), this.usuario, false, false);
                    ...
                    this.atendimento.setObservacao("Consulta não foi realizada erro na autenticação api pan: [ " + ConsultaAssincronaApiPanSimulacao.this.urlApi);
                }
                ...
                this.atendimento.setValorMaxOperacao(null);
                this.atendimento.setSeguro(null);
                this.atendimento.setObservacao(ConsultaAssincronaApiPanSimulacao.this.tratarErro(e.getMessage()));
            ...
            ConsultaAssincronaApiPanSimulacao.this.atualizarAtendimento(this.atendimento, this.campanha, this.usuario, this.empresa);
            return this.inicio;
        }
    ...
    public static void main(String[] args) {
        ...
        ConsultaAssincronaApiPanSimulacao consult = new ConsultaAssincronaApiPanSimulacao();
