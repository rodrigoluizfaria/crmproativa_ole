...
public class ObtemProdutosDeSeguroRetorno  implements java.io.Serializable {
    ...
    private TipoProdutoSeguro[] tiposDeSeguro;
    ...
    public ObtemProdutosDeSeguroRetorno(
           ...
           TipoProdutoSeguro[] tiposDeSeguro) {
     ...
     */
    public TipoProdutoSeguro[] getTiposDeSeguro() {
        return tiposDeSeguro;
    }
     ...
     * @param tiposDeSeguro
     */
    public void setTiposDeSeguro(TipoProdutoSeguro[] tiposDeSeguro) {
        this.tiposDeSeguro = tiposDeSeguro;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getTiposDeSeguro() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getTiposDeSeguro(), i);
                if (obj != null &&
