...
public class LimiteSaqueRetorno  implements java.io.Serializable {
    private CustoEfetivoTotal cet;

    private CustoEfetivoTotalParaCartaoCliente cetSaqueComplementar;
    ...
    public LimiteSaqueRetorno(
           CustoEfetivoTotal cet,
           CustoEfetivoTotalParaCartaoCliente cetSaqueComplementar,
     ...
     * @return cet
     */
    public CustoEfetivoTotal getCet() {
        return cet;
    }
     ...
     * @param cet
     */
    public void setCet(CustoEfetivoTotal cet) {
        this.cet = cet;
    }
     ...
     */
    public CustoEfetivoTotalParaCartaoCliente getCetSaqueComplementar() {
        return cetSaqueComplementar;
    }
     ...
     */
    public void setCetSaqueComplementar(CustoEfetivoTotalParaCartaoCliente cetSaqueComplementar) {
        this.cetSaqueComplementar = cetSaqueComplementar;
    }
