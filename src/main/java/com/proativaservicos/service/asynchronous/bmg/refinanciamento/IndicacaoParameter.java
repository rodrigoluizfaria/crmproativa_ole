...
public class IndicacaoParameter  extends com.proativaservicos.service.asynchronous.bmg.refinanciamento.AbstractWebServicesParameter  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://parameter.consignacao.econsig.bmg.com", "IndicacaoParameter"));
