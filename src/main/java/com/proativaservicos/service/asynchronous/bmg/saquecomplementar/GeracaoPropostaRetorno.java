...
public class GeracaoPropostaRetorno  implements java.io.Serializable {
    private DadosAssinaturaEletronica dadosAssinaturaEletronica;
    ...
    private String numeroPropostaGerada;

    private String[] numerosPropostasGeradasAutomaticamente;

    private DadosScript[] scripts;

    public GeracaoPropostaRetorno() {
    }

    public GeracaoPropostaRetorno(
           DadosAssinaturaEletronica dadosAssinaturaEletronica,
           boolean excecaoDeRegraDeNegocio,
           boolean excecaoGenerica,
           String mensagemDeErro,
           String numeroPropostaGerada,
           String[] numerosPropostasGeradasAutomaticamente,
           DadosScript[] scripts) {
     ...
     */
    public DadosAssinaturaEletronica getDadosAssinaturaEletronica() {
        return dadosAssinaturaEletronica;
    }
     ...
     */
    public void setDadosAssinaturaEletronica(DadosAssinaturaEletronica dadosAssinaturaEletronica) {
        this.dadosAssinaturaEletronica = dadosAssinaturaEletronica;
    }
     ...
     */
    public String getNumeroPropostaGerada() {
        return numeroPropostaGerada;
    }
     ...
     */
    public void setNumeroPropostaGerada(String numeroPropostaGerada) {
        this.numeroPropostaGerada = numeroPropostaGerada;
    }
     ...
     */
    public String[] getNumerosPropostasGeradasAutomaticamente() {
        return numerosPropostasGeradasAutomaticamente;
    }
     ...
     */
    public void setNumerosPropostasGeradasAutomaticamente(String[] numerosPropostasGeradasAutomaticamente) {
        this.numerosPropostasGeradasAutomaticamente = numerosPropostasGeradasAutomaticamente;
    }
     ...
     * @param scripts
     */
    public void setScripts(DadosScript[] scripts) {
        this.scripts = scripts;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getNumerosPropostasGeradasAutomaticamente() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getNumerosPropostasGeradasAutomaticamente(), i);
                if (obj != null &&
        ...
        if (getScripts() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getScripts(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
