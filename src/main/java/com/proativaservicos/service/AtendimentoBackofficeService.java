...
public class AtendimentoBackofficeService extends GenericProService<AtendimentoBackoffice> {
    ...
    public List<ProdutividadeSacDto> pesquisarProdutividadeAtendimentoSac(Long[] equipeLong, Long[] usuarioLong,
    ...
    public List<ProdutividadeSacDto> pesquisarProdutividadeAtendimentoSacTotal(List<Long> equipeLong, List<Long> usuarioLong,
                                                                               Long produtoLong, Long loja,
                                                                               Date dataInicio, Date dataFim) {
        return this.dao.pesquisarProdutividadeAtendimentoSacTotal(equipeLong, usuarioLong, produtoLong, loja, dataInicio, dataFim);
    }
