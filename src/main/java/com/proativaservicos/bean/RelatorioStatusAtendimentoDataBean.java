...
@Named
@ViewScoped
public class RelatorioStatusAtendimentoDataBean extends GenericBean {
    ...
    public void pesquisar() {
        ...
        try {
            ...
            this.listRelatorio = this.serviceAtendimento.pesquisarRelatorioStatusAtendimentoData(this.idCampanha, this.idStatusCampanha, this.tipoCampanha, this.idEquipe, this.idUsuario, this.dataInicial, this.dataFinal, getEmpresa().getId());
    ...
    public void onExportar() {
        ...
        try {
            ...
            exportarArquivoCsv(Arrays.asList(new String[]{"data", "tipo_campanha", "total_status", "taxa_conversao", "proposta_efetivada", "agendamento", "alos", "cpfs_trabalhados", "cpc", "status", "quantidade", "percentual"}), this.listRelatorio, "relatorio_" + format.format(new Date()) + ".csv");
    ...
    public void onActiveModal(List<Object[]> obj, String nome, String tipo) {
        ...
        title.setText("Data: " + nome + " - Tipo Campanha: " + tipo);
