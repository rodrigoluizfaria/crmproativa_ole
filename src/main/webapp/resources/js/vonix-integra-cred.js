...
/*MODO MANUAL*/
function iniciarIntegraVonixAtivo(servidor, login, isAutomatico, isHard,timeoutTmp) {
	...
	console.log("Iniciando script Vonix.... " + automatico+" - "+timeout);
...
function vonixTransfer(idCorrent, idTransfer) {
